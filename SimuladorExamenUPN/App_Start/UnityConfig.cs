...
namespace SimuladorExamenUPN
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IExamenService, ExamenService>();
            container.RegisterType<ISessionService, SessionService>();
            container.RegisterType<ITemasServices, TemasServices>(); 
            ...
            container.RegisterType<ITemaCategoriaService, TemaCategoriaService>();
        }
    }
}